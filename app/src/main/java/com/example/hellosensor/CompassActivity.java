...
public class CompassActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nice_img = (ImageView) findViewById(R.id.img_nice);
        txt_compass = (TextView) findViewById(R.id.txt_azimuth);
        nice_sound = MediaPlayer.create(this, R.raw.nice_sound);
    ...
    public void niceNorth(int azi){
        ...
        nice_img.setRotation(-azi);

        if(azi >= 350 || azi <= 10){
            nice_img.setVisibility(View.VISIBLE);
            compass_img.setVisibility(View.INVISIBLE);

            nice_sound.start();
        } else{
            nice_img.setVisibility(View.INVISIBLE);
